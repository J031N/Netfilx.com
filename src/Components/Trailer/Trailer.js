            ...
            <Grid container >
                ...
                <Grid item xs={8}>
                    <div className="trailerImage" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(${imageUrl + location.state.movie.backdrop_path})` }} >
                        ...
                        <div className='trailerContent' >
                            <Grid container>
                                <h1 style={{ fontSize: '50px', color: 'red' }} >{  location.state.movie.original_title }</h1>
                            </Grid>
                            ...
                            <Grid container>
                             ...
                             <Button onClick={()=>{
                                handleClicktrailer(location.state.movie.id)
                             }}  variant='contained' sx={{ color: 'black', backgroundColor: 'white', marginTop: '30px', }}>Play Trailer
                             </Button>
                ...
                <Grid item xs={4}>
                    <div className="trailerReview" style={{ backgroundColor: "#111", height: '37.5rem', padding: '20px', fontFamily: 'initial' }}>
                        <h1 style={{ fontSize: '45px', color: 'white' }}>{props.title? location.state.movie.title :location.state.movie.name  }</h1>
                       <div>
                        ...
                        <h5 style={{ color: 'gray',marginTop:'10px',fontSize:'17px' }} className="trailerReleaseDtae">Release Dtae : { location.state.movie.release_date }</h5>
